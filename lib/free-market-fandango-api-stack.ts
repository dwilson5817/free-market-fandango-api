    ...
    const apiGatewayToLambda = new ApiGatewayToLambda(this, 'API', {
      lambdaFunctionProps: {
        ...
        environment: {
          ...
          SPOTIPY_CLIENT_ID: process.env.SPOTIPY_CLIENT_ID || '3da1c2112e5b4746bd2758daf4e3afa4',
          SPOTIPY_CLIENT_SECRET: process.env.SPOTIPY_CLIENT_SECRET || '0d1abf192d644cf9abce27b887a79512',
          SPOTIPY_REDIRECT_URI: process.env.SPOTIPY_REDIRECT_URI || 'http://desktop01.new-york.dylanw.net:3000/spotify/connect',
